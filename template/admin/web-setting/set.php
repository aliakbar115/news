    ...
    <section class="col-12">
        ...
        <form method="post" action="<?= url('web-setting/store') ?>" enctype="multipart/form-data">
            <div class="form-group">
                <label for="title">Title</label>  <!-- یعنی اگر خالی نبود و یک رکورد ستینگ ثبت شده بودو ما می خواستیم آبدیت کنیم بیا چاپ کن  -->
                                                 <!-- چون صفحه آبدیت و کریت ما یکسان است شرط ایف گزاشته شد -->
