...
<section class="row my-3">
    <section class="col-12">
        ...
        <form method="post" action="<?= url('article/update/'.$id)?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <img style="width: 100px;" src="<?= asset($article['image']) ?>" alt=""> <!-- برای نمایش عکس قبلی-->
                <hr />
                <label for="image">Image</label>
                <input type="file" id="image" name="image" class="form-control-file" autofocus> <!-- گرفتن عکس جدید-->
            </div>
