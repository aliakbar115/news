            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    <?php foreach ($articlesWithView as $article) { ?>
                        <tr>
                            <td><a class="text-primary" href="<?= url('article/show/' . $article['id']) ?>"><?php echo  $article['id'] ?></a></td>
            ...
            <table class="table table-striped table-sm">
                ...
                <tbody>
                    <?php foreach ($lastComments as $comment) { ?>
                        ...
                        <tr>
                            <td><a class="text-primary" href="<?= url('comment/show/' . $comment['id']) ?>"><?php echo  $comment['id'] ?></a></td>
